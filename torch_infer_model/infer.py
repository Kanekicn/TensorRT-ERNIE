...
if __name__ == "__main__":
    ...
    parser.add_argument("-p", "--paddle_file", default='./sti2_data/model/paddle_infer_model',
                        type=str, help="The paddle model file path.")
    parser.add_argument("-i", "--input_file", default='./sti2_data/data/label.test.txt',
                        type=str, help="The onnx baseline file path.")
    parser.add_argument("-t", "--torch_model", default='./ernie_torch.pth',
                        type=str, help="torch model path")
